...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/nutkondee/android_kernel_manifest/refs/heads/android-16.0/manifest_brcm_rpi.xml --create-dirs
```
